...
$('#CrearNuevoHipercolesterolemia').submit(function(event) {
		...
		$.post('http://localhost/AppCardio/ApiREST/Hipercolesterolemia/Registrar', 
			{datos: datos}, 
			function(data) {
				if(data.estado == 1){
...
function ActualizarHipercolesterolemia(datos){
	alerta = '';
	$.post('http://localhost/AppCardio/ApiREST/Hipercolesterolemia/Actualizar', 
			{datos: datos}, 
			function(data) {
				if(data.estado == 1){
					alerta = '<div class="alert alert-success alert-dismissible" role="alert">';
...
function listarHipercolesterolemia(){
	$.post('http://localhost/AppCardio/ApiREST/Hipercolesterolemia/Listar',
		{datos: null},
		function(data) {
			if(data.Estado == 1){
